...
function App() {
  ...
  return (
    <div>
      <header className={dark?"text-white py-5 bg-black px-4 rounded-lg m-2":"px-4 rounded-lg m-2 bg-white py-5"}  style={{backgroundColor:"cadetblue"}}>
        <nav className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center font-semibold gap-x-1">
            <button className="py-1 px-3 cursor-pointer font-bold" style={{backgroundColor:"black",color:"white"}}>
